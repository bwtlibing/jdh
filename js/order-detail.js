...
window.onload=function () {
    ...
    (function () {
        ...
        var orderPage=parameter.page||1;
        var orderPay=parameter.orderPay;
       ...
       var switchStatus=undefined;/*切换按钮的状态控制变量*/
        ...
        function assignment(data) {
            ...
            } else if (data.orderStatus == '1'||data.orderStatus == '5') {
                status = '已取消';
            ...
            productImage.src = subLink(data.orderProduct.productImage);
            /*商品名字*/
            ...
            window.document.onkeypress=document.onirkeypress = function (event) {
                ...
                if (keyCode == 13) {//ok键
                    ...
                    if(i=='0'){
                        ...
                        if(document.referrer.indexOf('http://sx.iptv.bwton.com/jdh/views/order/order_pay.html'>-1)){
                           /*如果是从订单支付页面跳过来的，则跳到用户中心页面*/
